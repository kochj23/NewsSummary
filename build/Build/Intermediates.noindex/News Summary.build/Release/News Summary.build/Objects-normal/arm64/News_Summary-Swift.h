...
#ifndef NEWS_SUMMARY_SWIFT_H
#define NEWS_SUMMARY_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="News_Summary",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSXMLParser;
@class NSString;
SWIFT_CLASS("_TtC12News_Summary9RSSParser")
